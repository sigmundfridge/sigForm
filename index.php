...
<?php require_once("$root/template/top.php");?>
			...
			<ul>
				<li>Demo: <a href = "demo-anim.php">Animated</a> | <a href = "demo.php">Not animated</a></li>
			...
			<ul>
				<li><strike class = "done"><span>PRIORITY: Needs an 'animate' option so it doesn't have to pop-up.</span></strike> Added to v1.1</li>
